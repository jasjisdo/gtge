...
//    private final Rectangle collisionOffset = new Rectangle(0,0,0,0); // offset collision
 ...
 /****************************** SPRITE IMAGES *******************************/
	...
	/**
	 * Default collision shape used in {@link #getDefaultCollisionShape()},
	 * can be used in along with collision manager.
	 */
 ...
 /****************************************************************************/
	...
	/**
	 * Returns default {@linkplain #defaultCollisionShape collision shape},
	 * can be used along with collision manager.
	 */
	public CollisionShape getDefaultCollisionShape() {
		if (defaultCollisionShape == null) {
			defaultCollisionShape = new CollisionRect();
		}

		defaultCollisionShape.setBounds(getX(), getY(), getWidth(), getHeight());
...
//		}
 ...
 /****************************************************************************/
	...
	/**
	 * Returns the center of the sprite in <code>x</code> coordinate
	 * (x + (width/2)).
	 */
	...
	/**
	 * Returns the center of the sprite in <code>y</code> coordinate
	 * (y + (height/2)).
	 */
 ...
 /****************************************************************************/
	...
	public double getDistance(Sprite other) {
		return Math.sqrt(Math.pow(getCenterX()-other.getCenterX(),2) +
						 Math.pow(getCenterY()-other.getCenterY(),2));
	}
