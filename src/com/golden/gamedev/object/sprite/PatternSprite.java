...
/**
 * Sprite that its images is taken from another sprite (the pattern). <p>
 *
 ...
 * assure that <code>PatternSprite</code> that share the same pattern will 
 * animated in the same sequence. <p>
 *
...
public class PatternSprite extends Sprite {
 ...
 /****************************************************************************/
	...
	public void render(Graphics2D g, int x, int y) {
		g.drawImage(pattern.getImage(), x, y, null);
	}
